...
<body>
    ...
    <input type="submit" name="submit" class="sub_but" name="send">
    </form>
    </section>
...
<section class="footer">
    ...
    <div class="copyright">
        <hr>
        <p>Create by <span>WebCrafters</span>  ||  All rights reserved</p>
    </div>
</section>
...
<script>
    ...
    // Arrival and Leaving Date Validation
